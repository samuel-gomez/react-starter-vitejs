const basic = `<article className="af-panel">
<header className="af-panel__header">
  <span className="af-panel__title">Title</span>
</header>
<section className="af-panel__content">
  <p>
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque
    similique, quis aliquam temporibus velit ullam, quos quasi? Quod modi
    asperiores incidunt, velit repellendus, totam saepe quaerat voluptates cum
    quo facere.
  </p>
</section>
<footer className="af-panel__footer">
  <a
