Feature: Playground CheckboxInput
  ...
  @RG1
  Scenario: Affichage du playground CheckboxInput
    ...
    And un lien "Github" est visible avec un href "https://github.com/AxaGuilDEv/react-toolkit/tree/v2.1.0/packages/Form/Input/checkbox"
